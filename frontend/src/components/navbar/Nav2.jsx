import { Box, Flex, Hide, Image, Input, InputGroup, InputLeftElement, Link, Stack, } from '@chakra-ui/react'
    ...
    return (
        <Box margin="auto" w='70%' h='70px' display='flex' justifyContent='space-between'>
            ...
            <Flex margin='auto' mt='4' justifyContent={"space-between"} width="200px" >
                    <Box   display="flex" > <Link to=''><BsFillBagFill  style={{marginRight:'20px' ,color: 'black', border: '1px', fontSize: '25px' }} /></Link><span className='length'></span> </Box>
                    <Box className='vline'></Box>
                    <Box  mt='0.2' cursor={"pointer"}>  <Link to=''><RiAccountCircleFill size='30px' /></Link> </Box>
